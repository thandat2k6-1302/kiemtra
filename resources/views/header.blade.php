<div id="header">
    ...
    <div class="header-body">
        <div class="container beta-relative">
            <div class="pull-left">
                <a href="{{ route('banhang.index') }}" id="logo"><img src="/source/assets/dest/images/logo-cake.png" width="200px" alt=""></a>
            </div>
                    ...
                    <div class="cart">
                        ...
                        <div class="beta-dropdown cart-body">
                            ...
                            <div class="cart-caption">
                                ...
                                <div class="center">
                                    <div class="space10">&nbsp;</div>
                                    <a href="{{ route('banhang.checkout') }}" class="beta-btn primary text-center">Đặt hàng <i class="fa fa-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
                        @endif
